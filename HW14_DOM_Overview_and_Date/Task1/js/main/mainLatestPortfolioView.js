...
function renderLatestPortfolio(contentEl, data) {
  ...
  data.portfolioList.forEach((portfolio) => {
    ...
    latestPortfolioItem.className = `latest-portfolio__item latest-portfolio__item--${portfolio.img}`;
...
function makeLatestPortfolioPagination() {
  ...
  latestPortfolioPaginationItem.className = 'latest-portfolio__pagination-item';
